...
if __name__ == "__main__":
    ...
    if os.path.exists("dlio_strided_trace.csv"):
        label_traces_with_oracle("dlio_strided_trace.csv", "dlio_strided_labeled.csv")
    if os.path.exists("dlio_graph_walk_trace.csv"):
        label_traces_with_oracle("dlio_graph_walk_trace.csv", "dlio_graph_walk_labeled.csv")
    ...
    if os.path.exists("processed_traces/strided_normalized.parquet"):
        label_traces_with_oracle("processed_traces/strided_normalized.parquet", "processed_traces/strided_labeled.parquet")
    if os.path.exists("processed_traces/graph_walk_normalized.parquet"):
        label_traces_with_oracle("processed_traces/graph_walk_normalized.parquet", "processed_traces/graph_walk_labeled.parquet")
